...
Sain ratkottua ongelman opettajan avustuksella. Ongelmana siis oli se että SSH-avain oli tallentunut väärään paikkaan ja kotihakemiston omistus oli joltakin osin väärin root-käyttäjällä mutta sain sen hoidettua vaihtamalla omistuksen takaisin omalla käyttäjälleni. q
